  ...
  render() {
    return (
        <div>
            ...
            <div className = "relative bg-[#2C2C2CFF] py-6 flex justify-center lg:mt-52 md:mt-[700px] mt-[1100px] md:pb-52 pb-32">
            ...
            <div className = "lg:mt-[570px] md:mt-[1450px] mt-[1650px] w-full relative flex justify-center">
                <div className = "lg:flex justify-center align-center w-[50%] gap-5">
                    <div className = "">
                        <div className = "text-[27px] font-[700] text-[#353535FF] lg:text-left ">Our Clients Say
                        About Us
                        </div>
                        <div className = "text-[12px] font-[400] text-[#A3A3A3FF] text-left mt-3 lg:mt-0">Listen to firsthand experiences from our satisfied clients as they showcase our exceptional service, industry expertise, and the significant impact we've had on their investment success.</div>
                    </div>
            ...
            <footer className = "w-full bg-[#EAEEECFF] pt-20 pb-10 hidden lg:block">
                <div className = "flex justify-center">
                <div className = "lg:flex gap-12 items-start md:mx-10">
                    ...
                    <div className = "text-left">
                            ...
                            <div className = "flex gap-8">
                                ...
                                <div className="flex bg-[#FFFFFFFF] border-[1px] border-[#9C9D9D00] shadow-[0px_0px_1px_#171a1f12, 0px_0px_2px_#171a1f1F] mt-3 items-center rounded-[2px] px-4 gap-1">
                                    <div className = "-ml-2">
                            ...
                            <div className="flex bg-[#FFFFFFFF] border-[1px] border-[#9C9D9D00] shadow-[0px_0px_1px_#171a1f12, 0px_0px_2px_#171a1f1F] mt-3 items-center rounded-[2px] py-2 px-[18px] gap-1 w-max mt-5">
                                    <div className = "-ml-2">
            ...
            <footer className = "w-full bg-[#EAEEECFF] pt-20 pb-10 lg:hidden block">
